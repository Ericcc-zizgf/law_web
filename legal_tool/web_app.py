          ...
          <script>
            (() => {
              ...
              saveSettings.addEventListener('click', () => {
                ...
                const saved = api.saveSettings({ apiBaseUrl: baseUrl.value, accessCode: accessCode.value });
